...
## 4.4 Local Colocation of Water Points
...
We reject the null hypothesis that functional water points are randomly distributed at 95% confidence interval. As G\^~obs~(r) rises quickly and is greater than G~theo~(r) and the envelope it means the functional water points are clustered.
...
We reject the null hypothesis that non-functional water points are randomly distributed at 95% confidence interval. As G\^~obs~(r) rises quickly and is greater than G~theo~(r) and the envelope it means the functional water points are clustered.
